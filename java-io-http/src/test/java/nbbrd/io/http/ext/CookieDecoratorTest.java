...
public class CookieDecoratorTest {
    ...
    public void cookiesAreStoredAndReplayed() throws IOException {
        ...
        HttpClient client = new CookieDecorator(recording, new CookieManager(null, CookiePolicy.ACCEPT_ALL));
    ...
    public void cookiesAreCarriedAcrossRedirects() throws IOException {
        ...
        // Build the pipeline: Redirect wraps Cookie wraps base.
        HttpClient client = new RedirectDecorator(
                new CookieDecorator(
                        recording,
                        new CookieManager(null, CookiePolicy.ACCEPT_ALL))
                , 20, RedirectListener.noOp());
