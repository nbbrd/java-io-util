...
import static nbbrd.io.http.UriQueryBuilder.of;
...
public class UriQueryBuilderTest {
    ...
    public void testFactory() throws IOException {
        ...
        assertThat(of(urlWithoutSlash).build())
                .isEqualTo(uriBuilderAsURI(urlWithoutSlash, DO_NOTHING))
                .hasToString("http://localhost");

        assertThat(of(urlWithSlash).build())
                .isEqualTo(uriBuilderAsURI(urlWithSlash, DO_NOTHING))
                .hasToString("http://localhost/");
    }
    ...
    public void testPath() throws IOException {
        ...
        assertThat(of(urlWithoutSlash).path("hello").path("").path("worl/d").build())
                .isEqualTo(uriBuilderAsURI(urlWithoutSlash, o -> o.appendPathSegments("hello", "", "worl/d")))
                .hasToString("http://localhost/hello//worl%2Fd");

        assertThat(of(urlWithSlash).path("hello").path("").path("worl/d").build())
                .isNotEqualTo(uriBuilderAsURI(urlWithSlash, o -> o.appendPathSegments("hello", "", "worl/d")))
                .hasToString("http://localhost/hello//worl%2Fd");
    }
    ...
    public void testParam() throws IOException {
        ...
        assertThat(of(urlWithoutSlash).param("p1", "v1").param("p&=2", "v&=2").build())
                .isEqualTo(uriBuilderAsURI(urlWithoutSlash, o -> o.addParameter("p1", "v1").addParameter("p&=2", "v&=2")))
                .hasToString("http://localhost?p1=v1&p%26%3D2=v%26%3D2");

        assertThat(of(urlWithSlash).param("p1", "v1").param("p&=2", "v&=2").build())
                .isEqualTo(uriBuilderAsURI(urlWithSlash, o -> o.addParameter("p1", "v1").addParameter("p&=2", "v&=2")))
                .hasToString("http://localhost/?p1=v1&p%26%3D2=v%26%3D2");

        assertThat(of(urlWithoutSlash).path("hello").path("worl/d").param("p1", "v1").param("p&=2", "v&=2").build())
                .isEqualTo(uriBuilderAsURI(urlWithoutSlash, o -> o.appendPathSegments("hello", "worl/d").addParameter("p1", "v1").addParameter("p&=2", "v&=2")))
        ...
        assertThat(of(urlWithSlash).path("hello").path("worl/d").param("p1", "v1").param("p&=2", "v&=2").build())
                .isNotEqualTo(uriBuilderAsURI(urlWithSlash, o -> o.appendPathSegments("hello", "worl/d").addParameter("p1", "v1").addParameter("p&=2", "v&=2")))
                .hasToString("http://localhost/hello/worl%2Fd?p1=v1&p%26%3D2=v%26%3D2");

        assertThat(of(urlWithoutSlash).param("b", "2").param("a", "1").build())
                .isEqualTo(uriBuilderAsURI(urlWithoutSlash, o -> o.addParameter("b", "2").addParameter("a", "1")))
                .hasToString("http://localhost?b=2&a=1");

        assertThat(of(urlWithSlash).param("b", "2").param("a", "1").build())
                .isEqualTo(uriBuilderAsURI(urlWithSlash, o -> o.addParameter("b", "2").addParameter("a", "1")))
                .hasToString("http://localhost/?b=2&a=1");
    }
    ...
    public void testParamWithoutValue() throws IOException {
        ...
        assertThat(of(urlWithoutSlash).param("b").param("a").build())
                .isEqualTo(uriBuilderAsURI(urlWithoutSlash, o -> o.addParameter("b", null).addParameter("a", null)))
                .hasToString("http://localhost?b&a");

        assertThat(of(urlWithSlash).param("b").param("a").build())
                .isEqualTo(uriBuilderAsURI(urlWithSlash, o -> o.addParameter("b", null).addParameter("a", null)))
                .hasToString("http://localhost/?b&a");
    }
    ...
    public void testEncodingOfSpaceCharacter() throws IOException {
        assertThat(of(urlWithoutSlash).path("a b+").build())
                .isEqualTo(uriBuilderAsURI(urlWithoutSlash, o -> o.appendPathSegments("a b+")))
                .hasToString("http://localhost/a%20b%2B");

        assertThat(of(urlWithSlash).path("a b+").build())
                .isNotEqualTo(uriBuilderAsURI(urlWithSlash, o -> o.appendPathSegments("a b+")))
                .hasToString("http://localhost/a%20b%2B");

        assertThat(of(urlWithoutSlash).param("x y+", "a b+").build())
                .isEqualTo(uriBuilderAsURI(urlWithoutSlash, o -> o.addParameter("x y+", "a b+")))
                .hasToString("http://localhost?x%20y%2B=a%20b%2B");

        assertThat(of(urlWithSlash).param("x y+", "a b+").build())
                .isEqualTo(uriBuilderAsURI(urlWithSlash, o -> o.addParameter("x y+", "a b+")))
                .hasToString("http://localhost/?x%20y%2B=a%20b%2B");
    }

    private final URI urlWithoutSlash = Parser.onURI().parseValue("http://localhost").orElseThrow(RuntimeException::new);
    private final URI urlWithSlash = Parser.onURI().parseValue("http://localhost/").orElseThrow(RuntimeException::new);

    private static URI uriBuilderAsURI(URI base, Consumer<? super URIBuilder> consumer) {
        try {
