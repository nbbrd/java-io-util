...
public interface IOSupplier<T> {
     ...
     */
    @NonNull
    default <V> IOSupplier<V> andThen(@NonNull IOFunction<? super T, ? extends V> after) {
    ...
    @NonNull
    static <T> Supplier<T> unchecked(@NonNull IOSupplier<T> o) {
        return o.asUnchecked();
    }

    @NonNull
    static <T> IOSupplier<T> checked(@NonNull Supplier<T> o) {
    ...
    static <T> IOSupplier<T> of(@Nullable T t) {
        return () -> t;
    }
}
