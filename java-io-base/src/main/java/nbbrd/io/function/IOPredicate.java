...
public interface IOPredicate<T> {
    ...
    @JdkWithIO
    @NonNull
    default IOPredicate<T> and(@NonNull IOPredicate<? super T> other) {
    ...
    @JdkWithIO
    @NonNull
    default IOPredicate<T> or(@NonNull IOPredicate<? super T> other) {
        Objects.requireNonNull(other);
        return (t) -> testWithIO(t) || other.testWithIO(t);
    }
    ...
    @NonNull
    static <T> Predicate<T> unchecked(@NonNull IOPredicate<T> o) {
    ...
    @NonNull
    static <T> IOPredicate<T> of(boolean r) {
        return (o) -> r;
    }
}
